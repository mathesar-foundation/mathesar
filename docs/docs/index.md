...
If you're a developer, consider looking at the [git repo](https://github.com/centerofci/mathesar). The `README.md` in the git repo will get you started with helping us develop Mathesar.
