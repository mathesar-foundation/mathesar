...
!!!note
    The guide in these notes only supports upgrading from 0.1.3 to 0.1.4.
...
1. Copy the name of the directory containing `docker-compose.yml` and `.env` into the box below. Do not include a trailing slash.
...
1. Copy the name of the directory into the box below. Do not include a trailing slash.
