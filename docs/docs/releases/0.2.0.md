...
## Migrating to 0.2.0 from previous versions {:#migrate}
...
- **What you cannot migrate**: [user](../user-guide/users.md) accounts, passwords, [explorations](../user-guide/data-explorer.md), and [metadata](../user-guide/databases#understanding-mathesars-metadata.md).
