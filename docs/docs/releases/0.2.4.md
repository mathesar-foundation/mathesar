...
This release is a "hotfix" release written to fix issues with connecting databases to Mathesar over a unix socket. Please see our [0.2.3 release notes](./0.2.3.md) to learn about more recent features added to Mathesar, for example row duplication and enhanced paste behavior.

_This page provides a comprehensive list of all changes in the release._

## Unix socket connection fixes

TODO

- Fix: Can't create new databases when internal DB is running on a unix socket
- Fix: Can't connect internal DB over unix socket when a port is specified
- Fix: Can't create and modify data explorations when the base table's DB is connected over unix socket
