...
This is a minor hotfix release for Mathesar [0.10.0](./0.10.0.md). It corrects version metadata that was still reporting `0.9.0` in some places. This affected both Mathesar's reported version and versioned links in the documentation and release assets, including direct-install and Docker Compose downloads.
