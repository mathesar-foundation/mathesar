...
![Mathesar UI screenshot of picking a Mathesar user from a User-typed cell dropdown](../assets/releases/0.10.0/choose-user-col-dropdown.png)
///caption
...
*Related work:* [#4997](https://github.com/mathesar-foundation/mathesar/pull/4997 "Implement User data type")

### Last editor tracking

![Mathesar UI screenshot of the Last Editor Tracking section in the table inspector](../assets/releases/0.10.0/configure-last-edited-by.png)
///caption
...
![Mathesar UI screenshot of a Jobs table with a Last Edited By column populated after a record edit](../assets/releases/0.10.0/last-edited-by-example.png)
///caption
...
![Mathesar UI screenshot of editing a PostgreSQL ENUM-typed cell with a dropdown of valid values](../assets/releases/0.10.0/library-job-priority-enum.png)
///caption
...
*Related work:* [#5227](https://github.com/mathesar-foundation/mathesar/pull/5227 "Enums support")
...
*Related work:* [#5229](https://github.com/mathesar-foundation/mathesar/pull/5229 "Add Spanish and French translations")
...
*Related work:* [#5218](https://github.com/mathesar-foundation/mathesar/pull/5218 "Add configurable bind address for Mathesar")
...
- Run python tests on dependency version changes [#5253](https://github.com/mathesar-foundation/mathesar/pull/5253 "Run python tests on dependency version changes")
- Merge 0.9.0 release branch into develop [#5205](https://github.com/mathesar-foundation/mathesar/pull/5205 "Merge pull request #5195 from mathesar-foundation/release-0.9.0")
