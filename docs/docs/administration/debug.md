...
If you are just trying the Mathesar Docker image directly as instructed in the [local Docker guide](./try-mathesar-locally.md), you will follow the same approach of setting `DEBUG=true`:
