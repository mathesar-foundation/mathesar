...
The uninstall instructions vary depending on the [installation method](../index.md#getting-started) you chose. Select your installation method below to proceed.
