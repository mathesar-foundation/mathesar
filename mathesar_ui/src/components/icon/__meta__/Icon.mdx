...
Icon component design specification. Uses font-awesome icons.
Import the icon definition from any of the @fortawesome packages, and pass it to the icon.
