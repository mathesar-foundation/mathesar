...
<script lang="ts">
  ...
  // @mathesar-component-library import
  ...
  async function handleDeleteRecord() {
    void confirmDelete({
      ...
      onProceed: async () => {
        await record.delete();
        const tablePageUrl = `${window.location.origin}/db/${table.schema.database.id}/schema/${table.schema.oid}/table/${table.oid}/`;
