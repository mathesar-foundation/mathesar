<script lang="ts">
  ...
  import type { RelatedColumn } from '@mathesar/stores/table-data';
  import { Icon, Tooltip } from '@mathesar-component-library';

  export let relatedColumn: RelatedColumn;
...
<div class="related-header-cell-root">
  <CellBackground when={isSelected} color="var(--cell-bg-color-row-selected)" />
  <div class="related-header-cell-btn" on:click on:mousedown on:mouseenter>
    <div class="related-column-content">
      <div class="related-column-icon">
        <Icon {...iconTable} size="0.9em" />
      </div>
      <div class="related-column-name">
