import { faHammer, faArrowRight, faExclamationTriangle, faSpinner, faAngleDown,  faTimes,  faDragon, faUser, faProjectDiagram, faCogs, faTable, faFilter, faSort, faListAlt, faPlus, faLink, faTrashAlt, faTrash, faSortAmountDownAlt, faSortAmountDown, faThList, faICursor, faUnlink, faChevronRight, faDatabase, faPalette, faTimesCircle, faSync, faLock, faPencilAlt, faFileContract, faRedo, faUndo, faUpload, faKey, faSnowflake, faBackspace, faCheckSquare, faCalendarDay, faCalendarWeek, faStopwatch, faEnvelope, faQuestion, faDollarSign, faHashtag, faAlignLeft, faClock, faGlobe } from '@fortawesome/free-solid-svg-icons';
