...
SELECT format(
  ...
  -- TODO: We should really do GENERATED *ALWAYS* (rather than BY DEFAULT), but this breaks some
  -- other assumptions. There's no real reason to allow inserting into or updating our Mathesar
  -- system ID column, though.
