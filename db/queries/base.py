...
class DBQuery:
    ...
    def get_initial_column_by_input_alias(self, ix_of_transform, input_alias):
        ...
        preserve a unique constraint. E.g. if a filter transform preprocesses it or if it is
        generated by an aggregation.
        """
        initial_alias = self._get_initial_alias_by_input_alias(ix_of_transform, input_alias)
        if initial_alias is None:
            return None
        return self._get_initial_column_by_initial_column_alias(input_alias)
