...
from db.types import mathesar_char
...
def test_mathesar_char_type_column_creation(engine_email_type):
    ...
    with engine.begin() as conn:
        ...
        test_table = Table(
            "test_table",
            metadata,
            Column("char_col", mathesar_char.MATHESAR_CHAR),
        )
        test_table.create()


def test_mathesar_char_type_column_reflection(engine_email_type):
    engine, app_schema = engine_email_type
    with engine.begin() as conn:
    ...
    expect_cls = mathesar_char.MATHESAR_CHAR
