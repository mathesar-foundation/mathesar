...
def test_engines_having_separate_ischema_names(engine, engine_with_ischema_names_updated):
    """
    ...
    """
    ischema_names1 = engine.dialect.ischema_names
    ischema_names2 = engine_with_ischema_names_updated.dialect.ischema_names
...
def test_engines_having_appropriate_ischema_names(engine, engine_with_ischema_names_updated):
    """
    ...
    for ma_type in MathesarCustomType:
        assert ma_type.id not in engine.dialect.ischema_names
        assert ma_type.id in engine_with_ischema_names_updated.dialect.ischema_names
