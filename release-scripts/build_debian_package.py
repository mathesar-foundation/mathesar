...
DESC = """\
Builds .debs for mathesar, using a Docker image for the build environment.
"""
...
class Builder(object):
    ...
    def _inner_build(self, dist, skip_tests=False):
        ...
        # we tend to get source packages which are full of debs.
...
def run_builds(
    builder, dists, jobs=1, skip_tests=False
):
    def sig(signum: int, _frame):
        print("Caught SIGINT")
