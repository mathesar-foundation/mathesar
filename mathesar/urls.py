...
urlpatterns = [
    ...
    path('<db_name>/<int:schema_id>/queries/', views.schema_home, name="schema_home"),
    path('<db_name>/<int:schema_id>/queries/<int:query_id>/', views.schema_home, name="schema_home"),
]
