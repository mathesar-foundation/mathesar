...
db_router.register(r'connections', db_viewsets.DatabaseViewSet, basename='connection')
...
ui_router.register(r'connections', ui_viewsets.DatabaseViewSet, basename='connection')
