...
urlpatterns = [
    ...
    path('files/<slug:download_link_mash>/download/', views.download_link.download_file),
    path('files/<slug:download_link_mash>/thumbnail/', views.download_link.load_file_thumbnail),
