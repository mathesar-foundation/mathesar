...
class AnalyticsReport(BaseModel):
    ...
    recent_dql_query_count = models.PositiveIntegerField(null=True, blank=True)
    recent_dml_query_count = models.PositiveIntegerField(null=True, blank=True)
    recent_ddl_query_count = models.PositiveIntegerField(null=True, blank=True)
