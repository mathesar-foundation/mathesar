...
class Database(ReflectionManagerMixin, BaseModel):
    ...
    def is_connectable(self):
        ...
        try:
            ...
            # 1. not creating more engines (that are not not needed)
            # 2. and killing engines that were created (and not needed anymore)
            # Unfortunately, it also kills engines that are needed.
            # By needed, I mean actively serving user queries.
