...
from db.functions.base import Count, ArrayAgg, Sum, Median, Mode, Percentage_True, Max, Min, Mean, PeakTime, PeakDayOfWeek, Peak_Month
...
def _get_default_display_name_for_agg_output_alias(
    ...
    if output_alias and input_alias and agg_function:
        map_of_agg_function_to_suffix = {
            ...
            PeakDayOfWeek.id: " peak_day_of_week",
