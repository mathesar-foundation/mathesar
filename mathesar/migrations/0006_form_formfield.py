# Generated by Django 4.2.21 on 2025-07-03 07:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='formfield',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('column_attnum__isnull', False), ('kind', 'scalar_column')), models.Q(('column_attnum__isnull', False), ('constraint_oid__isnull', False), ('fk_interaction_rule__isnull', False), ('kind', 'foreign_key'), ('related_table_oid__isnull', False)), models.Q(('constraint_oid__isnull', False), ('kind', 'reverse_foreign_key'), ('related_table_oid__isnull', False)), _connector='OR'), name='form_field_kind_integrity'),
        ),
        migrations.RunSQL(
            sql="""
