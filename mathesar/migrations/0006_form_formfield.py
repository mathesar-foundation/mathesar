# Generated by Django 4.2.22 on 2025-07-01 23:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='formfield',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('kind', 'reverse_foreign_key'), ('column_attnum__isnull', False), _connector='OR'), models.Q(('kind', 'scalar_column'), models.Q(('constraint_oid__isnull', False), ('related_table_oid__isnull', False)), _connector='OR')), name='form_field_kind_integrity'),
        ),
        migrations.RunSQL(
            sql="""
