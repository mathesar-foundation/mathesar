...
@receiver(post_save, sender=Table)
def create_table_settings(sender, instance, **kwargs):
...
def compute_preview_column_settings(sender, instance, **kwargs):
    computed_preview_columns = [instance.primary_key]
