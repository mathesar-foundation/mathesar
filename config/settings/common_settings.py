...
DATABASES = {
    ...
    for db_key, url_string in [pipe_delim(i) for i in os.environ.get('MATHESAR_DATABASES').split(',')]
}
...
if TEST:
    for db_key, _ in [pipe_delim(i) for i in os.environ.get('MATHESAR_DATABASES').split(',')]:
